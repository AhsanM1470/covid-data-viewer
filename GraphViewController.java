...
public class GraphViewController extends ViewController {
    ...
    /**
     * Constructs a chart for the specified data range, borough selected, and data field selected.
     * 
    ...
    /**
     * Retrieves the data from the dataset for a given borough within a specified date range, 
     * and returns the data in a format that can be plotted on a chart.
     * 
     * @param fromDate The start date of the date range (inclusive)
     * @param toDate The end date of the date range (inclusive)
